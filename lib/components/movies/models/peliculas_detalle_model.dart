...
//
//     final peliculaDetalleModel = peliculaDetalleModelFromJson(jsonString);

import 'dart:convert';

PeliculaDetalleModel peliculaDetalleModelFromJson(String str) =>
    PeliculaDetalleModel.fromJson(json.decode(str));

String peliculaDetalleModelToJson(PeliculaDetalleModel data) =>
    json.encode(data.toJson());

class PeliculaDetalleModel {
  bool adult;
  String backdropPath;
  ...
  factory PeliculaDetalleModel.fromJson(
